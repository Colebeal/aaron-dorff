				...
				<>
					...
					>
						...
						<div className='rounded-lg bg-white row-span-2 col-span-2 text-stone-800 text-xl p-5'>
							...
							{productType == 'shelf' && (
								<h2 className='text-stone-700 text-3xl my-5'>Shelves</h2>
							)}
							{productType == 'record' && (
								<h2 className='text-stone-700 text-3xl my-5'>Record Holders</h2>
							)}
							{productType == 'build' && (
								<h2 className='text-stone-700 text-3xl my-5'>Build-Outs</h2>
							)}
							<p>
								Lorem ipsum dolor sit amet consectetur, adipisicing elit.
								Cupiditate harum quisquam hic voluptatum at eius, commodi dicta.
								Eligendi rem adipisci eveniet quas ad cupiditate ea facilis
								quasi dolorum, quae accusamus.
							</p>
							<ul className='mt-5'>
...
// ;<div className='flex flex-col row-span-3 col-span-2 gap-5'>
// 	<div className="rounded-lg grow basis-3/6 bg-[url('/image/Dorff-Board.jpg')] bg-cover bg-center"></div>
// 	<div className="rounded-lg grow basis-3/6 bg-[url('/image/Dorff-Craft-03.jpg')] bg-cover bg-center"></div>
// </div>
